...
const ICONS = {
  ...
  'trophy':          '<path d="M7.5 4h9v5.5a4.5 4.5 0 0 1-9 0V4Z"/><path d="M7.5 5.5H4V8a3.5 3.5 0 0 0 3.9 3.4"/><path d="M16.5 5.5H20V8a3.5 3.5 0 0 1-3.9 3.4"/><path d="M12 14v3.5"/><path d="M8.5 20.5h7"/>',
  'rocket':          '<path d="M12 2.5c2.8 1.6 4.4 4.8 4.4 8.4 0 2.7-.8 5.3-2.2 7.6h-4.4A15 15 0 0 1 7.6 10.9c0-3.6 1.6-6.8 4.4-8.4Z"/><circle cx="12" cy="9.5" r="1.7"/><path d="M7.6 12.6 5 15.4l1.4 3.6"/><path d="M16.4 12.6 19 15.4 17.6 19"/><path d="M10.4 21.5h3.2"/>',
  ...
  'pickaxe':         '<path d="M12.5 8.5 4.6 16.4a2.1 2.1 0 0 0 3 3l7.9-7.9"/><path d="M9.8 6.6 8.3 5.1l1.5-1.5a5 5 0 0 1 7.1 0l1.5 1.5-1.5 1.5"/><path d="M14.6 8.6 18.4 5"/>',
  'flag':            '<path d="M5 3v18"/><path d="M5 4h11l-2 4 2 4H5"/>',
  'coins':           '<circle cx="10" cy="10" r="6"/><path d="M15.2 5.4a6 6 0 0 1 0 13.2"/><path d="M10 7.5v5"/><path d="M8.4 9.2h3.2"/>',
  ...
  'scroll':          '<path d="M7 3h9a2 2 0 0 1 2 2v12a3 3 0 0 0 3 3H8a3 3 0 0 1-3-3V5a2 2 0 0 1 2-2Z"/><line x1="9" y1="8" x2="14" y2="8"/><line x1="9" y1="12" x2="14" y2="12"/>',
  ...
  'handshake':       '<path d="M12 8.5 9.4 5.9a2 2 0 0 0-2.8 0L3 9.5l5 5"/><path d="M12 8.5l2.6-2.6a2 2 0 0 1 2.8 0L21 9.5l-5 5"/><path d="M8 14.5l2.6 2.6a2 2 0 0 0 2.8 0l2.6-2.6"/>',
  ...
  'gem':             '<path d="M7 4h10l4 6-9 10L3 10l4-6Z"/><path d="M3 10h18"/><path d="M9.5 4 8 10l4 10 4-10-1.5-6"/>',
  'hammer':          '<path d="M13.5 4.5 20 11l-2.6 2.6L10.9 7.1l2.6-2.6Z"/><path d="M11.6 7.8 4 15.4V20h4.6l7.6-7.6"/>',
  ...
  'wheat':           '<path d="M12 22V9"/><path d="M12 9c-3 0-5-2-5-5 3 0 5 2 5 5Z"/><path d="M12 9c3 0 5-2 5-5-3 0-5 2-5 5Z"/><path d="M12 16c-3 0-5-2-5-5 3 0 5 2 5 5Z"/><path d="M12 16c3 0 5-2 5-5-3 0-5 2-5 5Z"/>',
  'footprints':      '<path d="M3.5 20.5h4v-4h-4v4Z"/><path d="M10 20.5h4v-9h-4v9Z"/><path d="M16.5 20.5h4V6.5h-4v14Z"/>',
  ...
  'party-popper':    '<path d="M4.2 20.8 9.3 9.4l5.6 5.6L3.5 20.1Z"/><path d="M13.5 5 15 3.5M17.6 8.4 19.5 7M15.5 12.5l1.9.6M12.5 3.4l.6 1.9M20 4.2l-1.3 1.4"/>',
  'search':          '<circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/>',
  'keyboard':        '<rect x="2" y="6" width="20" height="12" rx="2.5"/><path d="M6 10h.01M10 10h.01M14 10h.01M18 10h.01"/><path d="M7.5 14h9"/>',
  ...
  'book':            '<path d="M4 5a2 2 0 0 1 2-2h13v15H6a2 2 0 0 0-2 2V5Z"/><path d="M4 19a2 2 0 0 0 2 2h13"/><path d="M8 7h7M8 11h7"/>',
  'shield-check':    '<path d="M12 2.5 4.5 5.2v5.6c0 4.6 3.1 8.1 7.5 10.2 4.4-2.1 7.5-5.6 7.5-10.2V5.2L12 2.5Z"/><polyline points="9 11.5 11.5 14 15 10"/>',
  'sparkles':        '<path d="M12 3.5l1.6 3.9 3.9 1.6-3.9 1.6L12 14.5l-1.6-3.9L6.5 9l3.9-1.6L12 3.5Z"/><path d="M18.5 15l.8 1.9 1.9.8-1.9.8-.8 1.9-.8-1.9-1.9-.8 1.9-.8.8-1.9Z"/>',
  'copy':            '<rect x="9" y="9" width="12" height="12" rx="2"/><path d="M5 15V5a2 2 0 0 1 2-2h10"/>',
  'clock':           '<circle cx="12" cy="12" r="9"/><polyline points="12 7.5 12 12 15.5 13.8"/>',
