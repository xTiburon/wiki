...
(function () {
  ...
  function buildFooter() {
    ...
    return '<div class="footer-inner">' +
      ...
      '<div class="footer-logo"><div class="footer-logo-planet"></div><span>' + WIKI_DATA.site.name + '</span></div>' +
